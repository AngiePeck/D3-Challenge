...
// function used for updating circles group with new tooltip with x-label change
...
d3.csv("./assets/data/data.csv").then(function(data, err) {
  ...
  // append initial labels (state abbreviations) to circles
  ...
  // Append group for two x-axis labels
  var labelsGroup = chartGroup.append("g")
    .attr("transform", `translate(${width / 2}, ${height + 20})`);
  // define each x-label with an event listener
  ...
  // append y axis with label rotated
